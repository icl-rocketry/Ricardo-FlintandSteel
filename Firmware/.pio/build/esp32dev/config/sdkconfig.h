...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "ricpart.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "ricpart.csv"
...
#define CONFIG_ARDUINO_SERIAL_EVENT_RUN_CORE1 1
...
#define CONFIG_ESP32S2_PANIC_GDBSTUB CONFIG_ESP_SYSTEM_PANIC_GDBSTUB
